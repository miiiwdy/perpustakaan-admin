            ...
            <div class="card z-index-0">
              ...
              <div class="card-body">
                <form role="form text-left" method="POST" action="{{ route('register_user') }}">
                  ...
                  <div class="mb-3">
                    <input type="text" name="kelas" class="form-control" placeholder="kelas" aria-label="kelas" aria-describedby="email-addon">
                  </div>
                  <div class="mb-3">
                  ...
                  <p class="text-sm mt-3 mb-0">Already have an account? <a href="{{ route("login_user") }}" class="text-dark font-weight-bolder">Sign in</a></p>
                </form>
              </div>
            </div>
          </div>
